...
#3) list в пункт dict, ключами которого являются слова,
...
# 4) часто встречающиеся слова (sort), количество разных слов в тексте (set);

print('часто встречающихся слова:')
print()
...
popular_5words = popular_words[-10:]
...
print('Количество разных слов: ', len(differ_words))
